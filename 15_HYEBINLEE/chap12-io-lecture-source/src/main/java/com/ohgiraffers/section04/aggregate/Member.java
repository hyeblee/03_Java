package com.ohgiraffers.section04.aggregate;

import java.io.Serializable;
import java.util.Arrays;
import java.util.Objects;

// 외부 파일에 객체를 써줄 때, 객체의 고유한 설정값을 같이 넘겨줘야하므로 직렬화
public class Member implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return memNo == member.memNo && age == member.age && Objects.equals(id, member.id)
        && Objects.equals(pwd, member.pwd) && Objects.deepEquals(hobbies,
        member.hobbies) && bloodType == member.bloodType;
  }
